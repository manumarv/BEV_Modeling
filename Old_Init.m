...
% Obtained from Net Gain Motors Inc -
% https://www.go-ev.com/PDFs/HyPer_9_120V_Performance.pdf 
...
motor_energy = simout.motor_energy.Data(N);
 
battery_energy = simout.Battery_Energy(N); 
